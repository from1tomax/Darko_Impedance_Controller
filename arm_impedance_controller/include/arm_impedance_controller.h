#ifndef ARMIMPEDANCECONTROL_H
#define ARMIMPEDANCECONTROL_H
...
public:
  ...
  /*---- METHODS ----*/
  ArmImpedanceControl(double ts);

  Eigen::VectorXd whole_body_control_torque(Eigen::VectorXd q_a_des);

  Eigen::VectorXd null_space_torque(Eigen::VectorXd q_a, Eigen::VectorXd dq_a, Eigen::VectorXd q_a_des);
